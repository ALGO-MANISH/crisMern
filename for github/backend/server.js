...
app.get('/api',verifyUser,(req,res)=>{
    return res.json({Status : "Success", username: req.username, link : req.link, displayname :req.displayName})
})
...
app.post('/api/login',(req,res)=>{
    ...
    db.query(sql,[req.body.email, req.body.password],(err, data)=>{
        ...
        if(data.length>0){
            ...
            const token=jwt.sign({username,link,displayName},"our-jsonwebtoken-secret-key",{expiresIn :'1d'});
