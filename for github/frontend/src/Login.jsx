                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6">
                        <div className="text-center mb-4">
                            <img src={logo} alt="AxisMyIndia_logo" style={{ width: '35%', height: 'auto', padding :'10px' }} />
                        </div>
                        <div className="bg-white p-3 rounded border"> 
                            <form onSubmit={handleSubmit}>
                                ...
                                <button type="submit" className="btn btn-success btn-block rounded-5" style={{width:'100px'}}>Log in</button>
                            </form>
                        </div>
                    </div>
                </div>
